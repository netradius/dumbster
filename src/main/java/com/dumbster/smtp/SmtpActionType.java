...
public class SmtpActionType {
	...
	/**
	 * Internal representation of an unrecognized action: body text gets this
	 * action type.
	 */
	private static final byte UNREC_BYTE = (byte) 8;
	/**
	 * Internal representation of the blank line action: separates headers and
	 * body text.
	 */
	...
	/** CONNECT action. */
	public static final SmtpActionType CONNECT = new SmtpActionType(
			CONNECT_BYTE);
	/** EHLO action. */
	...
	/** "." action. */
	public static final SmtpActionType DATA_END = new SmtpActionType(
			DATA_END_BYTE);
	/** Body text action. */
